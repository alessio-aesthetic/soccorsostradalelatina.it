...
function Brand() {
  return (
    <Link href="/" className="flex min-w-0 items-center">
      <img
        src="/images/logo-latina-cropped.png"
        alt="Carroattrezzi Latina"
...
function PhoneLink({
  ...
  return (
    <Link
      href={`tel:${site.tel}`}
      className={`inline-flex items-center justify-center rounded-full bg-[#D97706] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-900/20 transition hover:bg-[#92400E] ${className}`}
    >
      {children}
    </Link>
  )
    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur">
      <Container className="flex min-h-20 items-center justify-between gap-6">
        ...
        <nav className="hidden items-center gap-8 text-sm font-semibold text-slate-700 lg:flex">
          <a href="#urgenze" className="hover:text-[#D97706]">
            Urgenze
          </a>
          <a href="#servizi" className="hover:text-[#D97706]">
            Servizi
          </a>
          <a href="#zone" className="hover:text-[#D97706]">
            Zone
          </a>
          <a href="#faq" className="hover:text-[#D97706]">
            Domande
          </a>
        </nav>
    ...
    <section className="relative overflow-hidden bg-[#FFFBEB]">
      ...
      <Container className="relative grid gap-8 pb-16 pt-12 lg:grid-cols-[0.62fr_1.38fr] lg:items-stretch lg:pb-24 lg:pt-20">
        <div className="flex flex-col justify-between rounded-[2rem] bg-white p-8 shadow-xl shadow-orange-950/10 ring-1 ring-orange-100 lg:p-10">
          <div>
            <p className="inline-flex rounded-full bg-orange-50 px-4 py-2 text-sm font-semibold text-[#92400E] ring-1 ring-orange-200">
            ...
            <div className="mt-7 space-y-5 text-lg leading-8 text-slate-700">
              <p>
                ...
                farti perdere luciditÃ . Il servizio di <strong>carroattrezzi a Latina</strong> Ã¨
                pensato per gestire guasti, incidenti, veicoli in panne e
                trasporti programmati con una procedura chiara.
              </p>
              <p>
                Lavoriamo su Latina, sulle strade di collegamento, nelle zone
        ...
        <div className="relative min-h-[660px] overflow-hidden rounded-[2rem] bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900 p-6 shadow-2xl shadow-slate-950/20">
          ...
          <img
            src="/images/hero-latina-technician.png"
            alt="Tecnico del carroattrezzi a Latina con mezzo di soccorso"
          ...
          <div className="absolute bottom-6 left-6 right-6 z-20 grid gap-3 sm:grid-cols-3">
            {[
              ...
              >
                <p className="font-display text-3xl font-bold text-[#D97706]">
                  {value}
                </p>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <span className="mt-5 inline-flex text-sm font-semibold text-[#D97706]">
                  Apri servizio
                </span>
              </div>
            </Link>
...
function Zones() {
  return (
    <section id="zone" className="bg-white py-24">
      <Container>
        <SectionTitle eyebrow="zone servite" title="Latina e comuni vicini, con assistenza organizzata.">
          <p>
    ...
    <section id="prezzi" className="bg-[#1F2937] py-24 text-white">
      <Container>
        <div className="grid gap-8 lg:grid-cols-[1fr_1fr_0.9fr]">
            ...
            <ol className="mt-6 space-y-5">
              {[
                ...
                <li key={title} className="flex gap-4">
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#D97706] text-sm font-black text-white">
                    {index + 1}
                  </span>
                  <span>
          ...
          <div className="rounded-[2rem] bg-[#D97706] p-8 text-white">
    ...
    <section className="bg-[#FFFBEB] py-20">
      <Container className="rounded-[2rem] bg-slate-950 p-8 text-white shadow-2xl shadow-slate-950/20 lg:flex lg:items-center lg:justify-between lg:p-12">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row lg:mt-0">
          <Link
            href={`tel:${site.tel}`}
            className="inline-flex items-center justify-center rounded-full bg-[#D97706] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-900/30 transition hover:bg-[#92400E]"
          >
            Chiama {site.phone}
          </Link>
        </div>
        ...
        <div className="grid gap-10 border-t border-slate-200 pt-10 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm leading-6 text-slate-600">
              Soccorso stradale, traino e recupero veicoli a Latina e
              provincia.
            </p>
          </div>
          <div>
...
function StickyCall() {
  return (
    <Link
      href={`tel:${site.tel}`}
      className="fixed bottom-4 right-4 z-40 inline-flex items-center justify-center rounded-full bg-[#D97706] px-4 py-3 text-xs font-bold text-white shadow-2xl shadow-orange-950/30 ring-1 ring-white/40 transition hover:bg-[#92400E] sm:px-5 sm:text-sm"
    >
      Chiama
    </Link>
  )
