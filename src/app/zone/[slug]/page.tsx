            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="mt-6 space-y-5 text-lg leading-8 text-slate-700">
                ...
                <p>
                  ...
                  zona di Latina. Anche quando il veicolo si trova in un
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link
                  href={`tel:${site.tel}`}
                  className="rounded-full bg-[#D97706] px-6 py-3 text-center text-sm font-semibold text-white"
                >
                  Chiama {site.phone}
                </Link>
              </div>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {services.slice(0, 9).map((service) => (
              <Link
                ...
                className="rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 font-semibold text-slate-800 transition hover:border-[#D97706]/40 hover:bg-white hover:text-[#D97706]"
              >
                {service.title}
              </Link>
            ))}
